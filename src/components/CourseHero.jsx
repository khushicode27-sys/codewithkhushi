    ...
    <section className="courses-hero">
      ...
      <div className="courses-hero-content">
        ...
        <h1>
          ...
          <span> for Kids & School Students</span>
        </h1>

        <p>
          Explore practical online courses in Coding, Python, C++,
          Web Development, Artificial Intelligence, Robotics and
          Scratch with project-based learning.
        </p>
